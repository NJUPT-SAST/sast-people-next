          ...
          <Section style={content}>
            ...
            {accept ? (
              ...
              <>
                ...
                <Text style={text}>
                  {flowKind === 'woc'
                    ? '我们对本阶段的任务完成情况进行了慎重评估。很遗憾地通知你，本次 WoC / WoD 未能通过，当前部员身份保持不变。'
                    : flowKind === 'soc'
                      ? '我们对本次暑期考核进行了慎重评估。很遗憾地通知你，本轮 SoC / SoD 留任未能通过，你的本次讲师留任申请到此结束。'
                      : '我们对每一位参与者都进行了慎重和综合的评估。经过艰难的抉择，我们很遗憾地通知你，本次未能通过我们的考核。我们深知这个结果可能会让你感到失望，但这绝非对你个人能力的否定，你的才华依然闪耀。'}
                </Text>
                <Text style={text}>
                  {flowKind === 'woc'
                    ? '感谢你在阶段考核中的投入和贡献，希望你继续保持对技术的热情，在后续活动中积累经验、不断进步。'
                    : flowKind === 'soc'
                      ? '感谢你在暑期活动中的投入和贡献，希望你继续保持对技术和教学的热情，祝你在接下来的学习与工作中一切顺利。'
