            ...
            <Card key={row.evaluation.id}>
              <CardHeader className="flex flex-col gap-3 pb-3">
                <div className="relative flex flex-col gap-2">
                  <CardTitle className="min-w-0 text-base leading-6 sm:pr-[45%] sm:text-sm">
                  ...
                  <div className="flex w-full shrink-0 flex-wrap items-center justify-end gap-2 sm:absolute sm:right-0 sm:top-0 sm:w-auto sm:max-w-[45%]">
