...
- failed CI runs only;
- all completed manual deployment runs, including success and failure.

It deliberately does not notify every push, successful CI run, or review
comment, to keep the group usable.
