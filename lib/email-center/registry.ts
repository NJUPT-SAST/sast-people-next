...
export const emailTemplateDefinitions = [
  ...
  },
  {
    ...
    category: "interview",
    name: "面试预约通知",
    description: "面试预约创建后发送给候选人的确认邮件。",
    ...
    variables: [
      ...
      { key: "meetingLink", label: "会议链接", required: true, example: "https://vc.feishu.cn/j/123456789" },
      { key: "location", label: "地点", required: false, example: "仙林校区大学生活动中心 101" },
      { key: "scheduleLink", label: "日程链接", required: false, example: "https://applink.feishu.cn/client/calendar/event/detail" },
    ],
  },
  {
    ...
    category: "interview",
    name: "面试改约通知",
    description: "面试时间或地点调整后发送给候选人的改约邮件。",
  ...
  },
  {
    ...
    variables: [
      ...
      { key: "startsAt", label: "开始时间", required: true, example: "2026-06-06 16:00" },
      { key: "endsAt", label: "结束时间", required: true, example: "2026-06-06 16:30" },
      { key: "meetingLink", label: "会议链接", required: false, example: "https://vc.feishu.cn/j/123456789" },
      { key: "location", label: "地点", required: false, example: "仙林校区大学生活动中心 101" },
    ],
  },
